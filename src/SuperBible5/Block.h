...
namespace Block
{
	...
	void SetupRC()
	{
		...
		// Wood floor
		pBytes = gltReadTGABits("../../testdata/superbible5_testdata/chapter01/block/floor.tga", &nWidth, &nHeight, &nComponents, &format);
		...
		pBytes = gltReadTGABits("../../testdata/superbible5_testdata/chapter01/block/Block4.tga", &nWidth, &nHeight, &nComponents, &format);
		...
		// Another block face
		pBytes = gltReadTGABits("../../testdata/superbible5_testdata/chapter01/block/Block5.tga", &nWidth, &nHeight, &nComponents, &format);
		...
		pBytes = gltReadTGABits("../../testdata/superbible5_testdata/chapter01/block/Block6.tga", &nWidth, &nHeight, &nComponents, &format);
